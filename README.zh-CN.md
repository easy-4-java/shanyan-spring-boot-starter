...
| JDK | `17` |
| 坐标 | `io.github.easy4j:shanyan-spring-boot-starter:1.0.0.RELEASE` |
| 配置前缀 | `shanyan` |
...
| 属性绑定 | ✅ 稳定 | 绑定 `shanyan.*` 到 `FlashMobileProperties` |
| `OkHttpClient` Bean | ✅ 稳定 | 通过 FlashMobileAutoConfiguration 自动注册 |
