...
| JDK | `17` |
| Coordinates | `io.github.easy4j:shanyan-spring-boot-starter:1.0.0.RELEASE` |
...
| Property Binding | ✅ Stable | Binds `shanyan.*` to `FlashMobileProperties` |
| `OkHttpClient` bean | ✅ Stable | Auto-registered via FlashMobileAutoConfiguration |
